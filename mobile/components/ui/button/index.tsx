...
const buttonStyle = tva({
  ...
  variants: {
    action: {
      primary:
        "bg-primary-main data-[hover=true]:bg-primary-dark data-[active=true]:bg-primary-dark border-primary-light data-[hover=true]:border-primary-light data-[active=true]:border-primary-main data-[focus-visible=true]:web:ring-indicator-info",
      secondary:
